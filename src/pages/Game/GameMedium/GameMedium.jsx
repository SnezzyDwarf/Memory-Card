...
import { fetchData } from "../../../services/dataMedium";

import "../styles/gameStyle.css";

export default function GameMedium({ handlerClick, score, selectCards }) {
  ...
  return (
    <>
      <section className="section-game">
        ...
        <div className="container-game6">
          {cardList.map((card) => (
            <div key={card.id} className="container-game_cards6">
              <button
